...
public class Values {
    ...
    public static int SLIDES_HRUNG = 110;
    public static int SLIDES_HRUNG_S = 220;
    public static int SLIDES_HBASKET = 680;
    ...
    public static double PINCH_MIN = 0.03; // Claw close
