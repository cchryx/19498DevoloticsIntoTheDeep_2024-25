...
public class ArmControl {
    ...
    public double aP = 0.025, aI = 0, aD = 0.0004, aF = 0.5; // TODO: RM STATIC AFTER TUNING (http://192.168.43.1:8080/dash)
    public int slidesTarget = 0, armTarget = Values.ARM_INIT; // TODO: RM STATIC AFTER TUNING (http://192.168.43.1:8080/dash)
    public int slidesPosition = 0, armPosition = 0;
    public double motorPowerSlides, motorPowerArm;
    public double slidesPID, armPID;

    // True PID values
    public double aP_T = 0.025, aI_T = 0, aD_T = 0.0004, aF_T = 0.5; // TODO: RM STATIC AFTER TUNING (http://192.168.43.1:8080/dash)
    // PID slopes
    ...
    public void initPosition() {
        ...
        motorPowerArm = Math.min(0.9, Math.max(aMinSpeed, motorPowerArm));
