...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5170.578195233853; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3223.648535682797; // x position of the perpendicular encoder (in tick units)
    }
